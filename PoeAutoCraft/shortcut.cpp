...
ShortCut::ShortCut(QString key, QApplication *a)
{
    m_key = QKeySequence(key);
    filter = new MyWinEventFilter(this);
    this->app = a;
    app->installNativeEventFilter(filter);
    registerHotKey();
}

void ShortCut::activateShortcut()
{
    emit activated();
}
bool ShortCut::registerHotKey()
{
...
quint32 ShortCut::nativeModifiers(Qt::KeyboardModifiers modifiers)
{
